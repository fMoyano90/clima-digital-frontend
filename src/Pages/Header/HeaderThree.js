...
export default function Header({ variant }) {
    ...
    return (
        <>
            ...
            <header className={`cp-header-area cp-header-style-1 ${ variant ? variant : "" } header__sticky ${isSticky ? "fixed-header" : ""}`}>
                <div id="cp-header-sticky" className="menu-area">
                    <div className="container">
                        <div className="second-menu">
                            <div className="row align-items-center">
                                <div className="col-xl-2 col-lg-2 col-md-7 col-4">
                                    <div className="logo">
                                        <Link to="/">
                                ...
                                <div className="col-xl-3 col-lg-3 col-md-4 col-3 text-left">
                                    <div className="cp-header-area-right">
                                        <Link to="tel:5550112" className="call-btn"><i className="icon-Group-7042"></i><span>Whatsapp:
                                                (208) 555-0112</span></Link>
                                    </div>
                                </div>
                                <div className="col-3">
                                    <div className="main-menu">
                                        <div className= {mobileToggle ? "mobile-menu-visible" : "mobile-menus"} >
                                            ...
                                            <div className="mobile-menu">
                                                ...
                                                <div className="close-btn" onClick={() => setMobileToggle(!mobileToggle)}><i className="icon-fa-times">X</i></div>
