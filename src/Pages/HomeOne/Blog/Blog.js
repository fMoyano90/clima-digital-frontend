  ...
  const blogData = [
    {
      ...
      image: news1,
      description:
        "Nulla vitae ex nunc.quis purus convallis, fermentum me volutpat, sodales purus. Nunc quis mauris",
        ...
        <div className='row justify-content-center'>
          <div className='col-xl-6 col-lg-6 col-12'>
            <div className='ch-top-title-s2'>
              <span>ÚLTIMOS BLOGS Y NOTICIAS</span>
              <h2 className='site-split-text ch-split-in-up'>
                DESCUBRE COMO LLEVAR TU EMPRESA AL PRÓXIMO NIVEL
              </h2>
            </div>
          </div>
        </div>
              ...
              <div className='col col-xl-6 col-lg-12 col-md-12 col-12' key={id}>
                ...
                >
                  ...
                  <div className='blog-content'>
                    <ul>
                      <li>
                        <i className='icon-user'></i> {item.author}
                      </li>
                      <li>
